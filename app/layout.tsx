...
export const metadata: Metadata = {
  ...
  description:
    "株式会社ゼゼヒヒ（ゼゼヒヒ／ZEZEHIHI）は「是々非々」の精神を持ち、既存の枠組みにとらわれず顧客メリットを最大化する会社です。不動産集客支援業、広告業、各種代理店、SNSアカウント運用代理店を東京都新宿区で展開しています。",
  keywords: [
    "ゼゼヒヒ",
    "ぜぜひひ",
    "ZEZEHIHI",
  ...
  openGraph: {
    ...
    description:
      "株式会社ゼゼヒヒ（ゼゼヒヒ／ZEZEHIHI）は「是々非々」の精神を持ち、既存の枠組みにとらわれず顧客メリットを最大化する会社です。",
    images: [
      {
  ...
  verification: {
    google: "RpKSsflCHWCI7zJ6e5UYtQujqub8mTduWMZTm6g2U3o",
  },
};
